<template>
  <div class="setter-wrapper">
    <el-tabs v-model="confType" type="border-card" stretch>
      <el-tab-pane name="baseConf" label="Pengaturan Dasar">
        ...
        >
          ...
          <h4 class="tipFont">Pilih jenis pertanyaan untuk mengedit</h4>
          <span class="tip">Ayo! Coba sekarang~</span>
        </div>
      ...
      <el-tab-pane name="globalBaseConf" label="Pengaturan Global">
        <SetterField
